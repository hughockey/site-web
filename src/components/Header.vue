...
const emit = defineEmits<{
  (e: "scroll-to-section", sectionRef: string): void;
  (e: "navigate", path: string): void;
}>();

const url = computed(() => {
  return currentRoute.value === "/" ? "/projects" : "/";
});
const navLabel = computed(() => {
  return currentRoute.value === "/" ? "Projets" : "Accueil";
});
...
<template>
  <div class="header-container">
    <div class="left-header-content">
      <a class="projects-link" href="/projects" @click.prevent="goTo(url)">{{
        navLabel
      }}</a>
    </div>
    <div class="right-header-content">
      <div class="socials-contact">
          ...
          >
            <g data-testid="github">
              ...
              <g class="frame-children">
                <g data-testid="svg-path">
                  <path
                    d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.402 5.402 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"
                    style="fill: none"
                    class="fills"
                  />
                  <g
        ...
        <button
          ...
          @click="$emit('scroll-to-section', 'contact-section')"
        >
          Contactez-moi
        </button>
      </div>
